...
### Iteration 1: Hotkey & App Skeleton (TBD)

**Implemented:**
- [TBD] US-001: Hotkey toggles state (FR-010, UC-001)
- [TBD] US-002: Tray icon reflects state (FR-010)
- [TBD] US-003: Hotkey conflict error dialog (FR-021)

**Tests:**
- [TBD] BDD: @Iter-1 @FR-010 scenarios passing
- [TBD] Manual: All acceptance criteria verified

**Metrics:**
- N/A (no performance targets this iteration)

**Notes:**
- [TBD] Hotkey uses Win32 RegisterHotKey API
- [TBD] State machine is simple enum with transition logging

---

### Iteration 2: Audio Recording (TBD)

**Implemented:**
- [TBD] US-010: Audio recording via WASAPI (FR-011)
- [TBD] US-011: WAV validation (16kHz, mono, 16-bit)
- [TBD] US-012: Microphone error handling (FR-021)

**Tests:**
- [TBD] BDD: @Iter-2 @FR-011 scenarios passing
- [TBD] Manual: WAV file inspection, error injection

**Metrics:**
- [TBD] WAV file size: ~160 KB for 5s recording

**Notes:**
- [TBD] Using NAudio library for WASAPI access
